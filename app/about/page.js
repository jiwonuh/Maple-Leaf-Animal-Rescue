...
export default function AdminDashboardPage() {
  return (
    ...
    <div className="text-2xl font-bold ">
      ...
      {/* Title of the page */}
      <div className="text-center text-white bg-red-900 border-amber-700 border-8 border-double rounded-full">
          <h1 className="mb-3 mt-3 font-mono">Giving Every Animal a Second Chance</h1>
      </div>

      {/* The main paragraoh of the introduction of the association */}
      <div className="mt-8 text-red-900 border-b-3">
      ...
      <div className="mt-9 font-medium flex justify-center text-red-900">
        <ul className="text-left font-mono text-lg">
      ...
      {/* More explainations */}
      <div className="mt-10 border-t-3 text-base text-red-900">
      ...
      {/* Call to action */}
      <div className="text-center mt-10 border-t-3 text-red-900 font-mono text-ml">
